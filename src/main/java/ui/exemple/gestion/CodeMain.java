...
public class CodeMain extends JFrame {
    ...
    private JComboBox<String> produits=new JComboBox<>();
    private JComboBox<String> type = new JComboBox<>();
    private JLabel label=new JLabel("lol");
    private JButton valider =new JButton("valider");

    public CodeMain() throws Exception {
    ...
    private void initialiseProduit()
    {
        String produits []  ={"poivron","couche"};
        for (String produit : produits) {
            
            this.produits.addItem(produit);
        }
    }
